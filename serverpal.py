...
from _core import app_config as cfgmod
from _core import antibug_system as antibug_core
from _core import antibug_enforcer as antibug_enf
...
class ManagerServerPalApp:
    ...
    def _discord_forward_chat(self, player_name: str, channel: str, message: str):
        ...
        def _send():
            try:
                from _core.discord_bridge import forward_chat_to_discord
