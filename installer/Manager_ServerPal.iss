...
Source: "..\docs\HUONG_DAN.txt"; DestDir: "{app}\docs"; Flags: ignoreversion
; Đóng gói trọn bộ dự án để app chạy độc lập (không cần Python/Node cài sẵn).
Source: "..\*.py"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\_core\*"; DestDir: "{app}\_core"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "__pycache__\*,*.pyc"
...
Name: "{group}\Hướng dẫn ({#MyAppName})"; Filename: "{app}\docs\HUONG_DAN.txt"
